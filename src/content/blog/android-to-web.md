...
Everywhere I looked, I saw mentions of React, Next.js and Tailwind CSS, so I decided to give them a try. Around this time, the Next.js app directory had just been announced. Without much thought, I ran `npm install next` and began building my first app.
